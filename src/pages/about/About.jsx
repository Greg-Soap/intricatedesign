      ...
      <div className="about_wrapper">
        <div className="about_left_content">
          ...
          <div className="about_body">
            <p>
              INTRICATE DESIGN is an interior design and decor company located
              in West Africa, Nigeria. At Intricate Design, we believe that our
              clients deserve the best life has to offer; that is exactly what
